...
export const C = {
  ...
  mid: "#636E72", 
  light: "#B2BEC3",
  green: "#1D9E75",  // color-paid
  paid: "#1D9E75",
  yellow: "#BA7517", // color-warning
  overdue: "#E24B4A",// color-overdue
  red: "#E24B4A",
  rose: "#E24B4A",
  blue: "#378ADD",   // color-info
  info: "#378ADD",
  purple: "#6C5CE7",
};
...
export const FESTIVAL_CALENDAR = [
  ...
  { name: "Akshaya Tritiya", month: 4, day: 10, season: "Investment" },
  { name: "Monsoon Arrival", month: 6, day: 1, season: "Rainy" },
  { name: "Independence Day", month: 8, day: 15, season: "National" },
  { name: "Raksha Bandhan", month: 8, day: 19, season: "Gifting" },
  { name: "Ganesh Chaturthi", month: 9, day: 7, season: "Festival" },
  { name: "Navratri", month: 10, day: 3, season: "Festival" },
  { name: "Dussehra", month: 10, day: 12, season: "Festival" },
  { name: "Diwali", month: 10, day: 31, season: "Mega-Festival" },
  { name: "Wedding Season", month: 11, day: 15, season: "High-Value" },
  { name: "Christmas / New Year", month: 12, day: 25, season: "Global" },
];

export const CATEGORY_STRATEGY_MAP: Record<string, any> = {
  "Groceries": {
    "Festival": "Stock up on Ghee, Sweets, and Spices. Demand spikes 3.5x.",
    "Rainy": "Increase stock of tea, coffee, and instant snacks.",
    "Investment": "High demand for premium grains and oils.",
    "suggestedAdditions": ["Organic Honey", "Dry Fruit Gift Packs", "Cold Pressed Oils"]
  },
  "Electronics": {
    "Festival": "Plan exchange offers. Mobile & TV demand projected +200%.",
    "National": "Launch 'Independence' bundle deals on accessories.",
    "High-Value": "Peak season for home appliances and wedding gifts.",
    "suggestedAdditions": ["Air Purifiers", "Smart Doorbells", "Gifting Powerbanks"]
  },
  "Clothing": {
    "Festival": "New ethnic collection arrival. Focus on kids & women's wear.",
    "Wedding": "Promote suit sets and luxury fabrics. Inventory velocity: HIGH.",
    "Rainy": "Rainwear and waterproof accessories priority.",
    "suggestedAdditions": ["Silk Scarves", "Designer Buttons", "Ethnic Footwear"]
  },
  "Home & Garden": {
    "Festival": "Home decor and lighting demand surge. Ready the 'Lamps' section.",
    "Rainy": "Waterproofing solutions and indoor plants focus.",
    "High-Value": "Kitchenware bundles for wedding gifting.",
    "suggestedAdditions": ["Aromatic Candles", "Smart LED Strips", "Indoor Water Fountains"]
  },
  "Others": {
    "Festival": "General gifting demand. Package your bestsellers as bundles.",
    "National": "Promote local-made products for patriotic sentiment.",
    "High-Value": "Focus on high-margin gift items.",
    "suggestedAdditions": ["Greeting Cards", "Eco-friendly Bags", "Handmade Chocolates"]
  }
};

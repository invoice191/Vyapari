...
import { Eye, EyeOff, Mail, Lock, User, Store, Phone, ArrowRight, Loader2, CheckCircle2, KeyRound } from "lucide-react";
...
const SignUp = () => {
  ...
  const onVerifyOtp = async (e: React.FormEvent) => {
    e.preventDefault();
    if (otp.length < 4) return toast("Enter a valid code", "error");
          ...
          <div className="w-full max-w-md rounded-[2rem] bg-card-glass p-6 shadow-card-soft border border-white/40 md:p-8">
            ...
            {step === "form" ? (
              ...
              <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                <h2 className="mt-4 font-display text-2xl font-bold tracking-tight">Verify Email --</h2>
                <p className="mt-1 text-sm text-muted-foreground">
                  We sent a verification code to <span className="font-medium text-foreground">{form.email}</span>.
                </p>
                ...
                <form onSubmit={onVerifyOtp} className="mt-8 space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-10 h-14 text-center tracking-widest text-lg font-bold rounded-xl bg-background/60 border-border/60"
                        required
                        autoFocus
                      />
                    </div>
                  ...
                  <p className="text-center text-sm text-muted-foreground">
                    ...
                    <button type="button" onClick={onSubmit} className="font-semibold text-primary hover:underline">
                      Resend
                    </button>
                  </p>
                </form>
